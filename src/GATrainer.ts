...
export class GATrainer implements TrainerController {
  ...
  public reset(): void {
    ...
    for (let i = 0; i < POP_SIZE; i++) {
      this.population.push(this.environment.createAgent(this.ga.randomPolicy()));
    }
  ...
  public getState(randomBoardCount = 0): TrainerState {
    ...
    return {
      ...
      historyLabel: "GA best fitness history",
  ...
  private evolve(): void {
    const { best, nextPolicies } = this.ga.evolve(this.population);
