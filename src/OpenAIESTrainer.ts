...
import {
  ...
  OPENAI_ES_POPULATION_SIZE,
} from "./OpenAIEvolutionStrategy";
...
export class OpenAIESTrainer implements TrainerController {
  private readonly es = new OpenAIEvolutionStrategy();
  ...
  public getState(randomBoardCount = 0): TrainerState {
    ...
    return {
      ...
      alive,
      batchSize: OPENAI_ES_POPULATION_SIZE,
      ...
      historyLabel: "OpenAI-ES best fitness history",
